...
-- Step 1: Fetch all Foreign Keys referencing dbo.AspNetUsers
...
PRINT 'Truncating table dbo.AspNetUserRoles';
TRUNCATE TABLE dbo.AspNetUserRoles;

PRINT 'Truncating table dbo.AspNetUserTokens';
TRUNCATE TABLE dbo.AspNetUserTokens;

PRINT 'Truncating table dbo.AspNetUsers';
