...
-- Step 1: Fetch all Foreign Keys referencing dbo.BCAUsers
...
PRINT 'Truncating table dbo.BCAUserStatusHistory';
TRUNCATE TABLE dbo.BCAUserStatusHistory;

PRINT 'Truncating table dbo.UserDocuments';
TRUNCATE TABLE dbo.UserDocuments;

PRINT 'Truncating table dbo.DailyTransactions';
TRUNCATE TABLE dbo.DailyTransactions;

PRINT 'Truncating table dbo.BCAUsers';
TRUNCATE TABLE dbo.BCAUsers;
